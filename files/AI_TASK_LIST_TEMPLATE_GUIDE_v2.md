...
**Version**: 2.2 (derived governance + minimalism)
**Core insight**: If a rule is not enforced by a command, it is guidance, not governance.

---

## Derived Governance (v2.2)
...
**If you use different governance docs, update this table in your project's task list.**

---

## The Four Drift Killers (v2.2)
...
4. **uv-only execution** — Eliminates "works locally but not in CI" command drift

---

## No Weak Tests (v2.2 Task Gate)
