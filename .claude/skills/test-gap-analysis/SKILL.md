...
**This skill invokes the [test-gap-analysis](../../agents/test-gap-analysis.md) agent.**
...
```bash
> Use the test-gap-analysis agent to verify my code
```

**Examples**:
```bash
> Use the test-gap-analysis agent before committing

> Have the test-gap-analysis agent check for issues

> Ask the test-gap-analysis agent to analyze the codebase
```
...
Task(
    ...
    prompt="Run test-gap-analysis analysis and report all findings with exact locations."
)
```
...
uv run fact-file-query-tool test-gaps
echo "✅ Test Gap Analysis passed"
```
...
# Run validation
echo "🔍 Running Test Gap Analysis..."
uv run fact-file-query-tool test-gaps --format summary
echo "✅ Test Gap Analysis passed"

uv run fact-file-query-tool test-gaps --format json

uv run fact-file-query-tool test-gaps --file path/to/file.py
```
...
**Agent file**: [test-gap-analysis](../../agents/test-gap-analysis.md)
...
**Invocation**:
```bash
> Use the test-gap-analysis agent to verify my code before committing
```
...
Task(subagent_type="test-gap-analysis", ...)
...
- **Agent**: [test-gap-analysis](../../agents/test-gap-analysis.md)
