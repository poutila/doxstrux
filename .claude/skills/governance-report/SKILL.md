...
description: Generate comprehensive governance compliance report. Use when requesting complete code quality dashboard or comprehensive compliance overview. Shows complexity, SOLID, docs, errors, types, security across entire codebase.
allowed-tools: Bash, Read, Task
---

# Governance Report Skill

**This skill invokes the [governance-report](../../agents/governance-report.md) agent.**
...
```bash
> Use the governance-report agent to verify my code
```

**Examples**:
```bash
> Use the governance-report agent before committing

> Have the governance-report agent check for issues

> Ask the governance-report agent to analyze the codebase
```
...
```python
Task(
    subagent_type="governance-report",
    description="Check code quality",
    prompt="Run governance-report analysis and report all findings with exact locations."
)
```
...
uv run fact-file-query-tool governance-report
echo "✅ Governance Report passed"
```
...
# Run validation
echo "🔍 Running Governance Report..."
uv run fact-file-query-tool governance-report --format summary
echo "✅ Governance Report passed"

uv run fact-file-query-tool governance-report --format json

uv run fact-file-query-tool governance-report --file path/to/file.py
```
...
**Agent file**: [governance-report](../../agents/governance-report.md)
...
**Invocation**:
```bash
> Use the governance-report agent to verify my code before committing
```
...
Task(subagent_type="governance-report", ...)
...
- **Agent**: [governance-report](../../agents/governance-report.md)
