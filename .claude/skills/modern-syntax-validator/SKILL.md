...
description: Enforce modern Python syntax before committing. Use proactively to enforce list[T] instead of List[T], X | None instead of Optional[X], and other PEP 604/585 modern type syntax patterns.
allowed-tools: Bash, Read, Task
---

# Modern Syntax Validator Skill

**This skill invokes the [modern-syntax-validator](../../agents/modern-syntax-validator.md) agent.**
...
```bash
> Use the modern-syntax-validator agent to verify my code
```

**Examples**:
```bash
> Use the modern-syntax-validator agent before committing

> Have the modern-syntax-validator agent check for issues

> Ask the modern-syntax-validator agent to analyze the codebase
```
...
```python
Task(
    subagent_type="modern-syntax-validator",
    description="Check code quality",
    prompt="Run modern-syntax-validator analysis and report all findings with exact locations."
)
```
...
# Run validation
echo "🔍 Running Modern Syntax Validator..."
uv run fact-file-query-tool modern-syntax
echo "✅ Modern Syntax Validator passed"
```
...
# Run validation
echo "🔍 Running Modern Syntax Validator..."
uv run fact-file-query-tool modern-syntax --format summary
echo "✅ Modern Syntax Validator passed"

uv run fact-file-query-tool modern-syntax --format json

uv run fact-file-query-tool modern-syntax --file path/to/file.py
```
...
**Agent file**: [modern-syntax-validator](../../agents/modern-syntax-validator.md)
...
**Invocation**:
```bash
> Use the modern-syntax-validator agent to verify my code before committing
```
...
Task(subagent_type="modern-syntax-validator", ...)
...
- **Agent**: [modern-syntax-validator](../../agents/modern-syntax-validator.md)
