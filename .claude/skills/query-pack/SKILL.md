---
name: query-pack
description: Execute pre-built query packs for common workflows. Use when you need comprehensive entity profiles or pre-configured analysis bundles (scorecards, docs, architecture) without manual query construction.
allowed-tools: Bash, Read, Task
---

# Query Pack Skill

**This skill invokes the [query-pack](../../agents/query-pack.md) agent.**
...
```bash
> Use the query-pack agent to verify my code
```

**Examples**:
```bash
> Use the query-pack agent before committing

> Have the query-pack agent check for issues

> Ask the query-pack agent to analyze the codebase
```
...
```python
Task(
    subagent_type="query-pack",
    description="Check code quality",
    prompt="Run query-pack analysis and report all findings with exact locations."
)
```
...
# Run validation
echo "🔍 Running Query Pack..."
uv run fact-file-query-tool query-pack
echo "✅ Query Pack passed"
```
...
# Run validation
echo "🔍 Running Query Pack..."
uv run fact-file-query-tool query-pack --format summary
echo "✅ Query Pack passed"

uv run fact-file-query-tool query-pack --format json

uv run fact-file-query-tool query-pack --file path/to/file.py
```
...
**Agent file**: [query-pack](../../agents/query-pack.md)
...
**Invocation**:
```bash
> Use the query-pack agent to verify my code before committing
```
...
- **Agent**: [query-pack](../../agents/query-pack.md)
