...
description: Detect import-time side effects before committing. Use proactively to prevent I/O, network, or database operations at import time that cause test flakiness, slow imports, and deployment issues.
allowed-tools: Bash, Read, Task
---

# Module Purity Check Skill

**This skill invokes the [module-purity-check](../../agents/module-purity-check.md) agent.**
...
- Database connections at import
- Network calls during import
- Environment variable reads at module level
...
```bash
> Use the module-purity-check agent to verify my code
```

**Examples**:
```bash
> Use the module-purity-check agent before committing

> Have the module-purity-check agent check for issues

> Ask the module-purity-check agent to analyze the codebase
```
...
Task(
    ...
    prompt="Run module-purity-check analysis and report all findings with exact locations."
)
```
...
# Run validation
echo "🔍 Running Module Purity Check..."
uv run fact-file-query-tool module-purity
echo "✅ Module Purity Check passed"
```
...
# Run validation
echo "🔍 Running Module Purity Check..."
uv run fact-file-query-tool module-purity --format summary
echo "✅ Module Purity Check passed"

uv run fact-file-query-tool module-purity --format json

uv run fact-file-query-tool module-purity --file path/to/file.py
```
...
**Agent file**: [module-purity-check](../../agents/module-purity-check.md)
...
**Invocation**:
```bash
> Use the module-purity-check agent to verify my code before committing
```
...
Task(subagent_type="module-purity-check", ...)
...
- **Agent**: [module-purity-check](../../agents/module-purity-check.md)
