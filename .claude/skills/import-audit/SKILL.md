---
name: import-audit
description: Check import style violations before committing. Use proactively to enforce import consistency - catch wildcard imports (from x import *), multi-dot relative imports (from ...module), and other import anti-patterns.
allowed-tools: Bash, Read, Task
---

# Import Audit Skill

**This skill invokes the [import-audit](../../agents/import-audit.md) agent.**
...
2. **Multi-dot relative** - `from ...parent import x`
3. **Circular imports** - Import cycles
...
```bash
> Use the import-audit agent to verify my code
```

**Examples**:
```bash
> Use the import-audit agent before committing

> Have the import-audit agent check for issues

> Ask the import-audit agent to analyze the codebase
```
...
```python
Task(
    subagent_type="import-audit",
    description="Check code quality",
    prompt="Run import-audit analysis and report all findings with exact locations."
)
```
...
uv run fact-file-query-tool import-audit
...
# Run validation
echo "🔍 Running Import Audit..."
uv run fact-file-query-tool import-audit --format summary
echo "✅ Import Audit passed"

uv run fact-file-query-tool import-audit --format json

uv run fact-file-query-tool import-audit --file path/to/file.py
```
...
**Agent file**: [import-audit](../../agents/import-audit.md)
...
**Invocation**:
```bash
> Use the import-audit agent to verify my code before committing
```
...
Task(subagent_type="import-audit", ...)
...
- **Agent**: [import-audit](../../agents/import-audit.md)
