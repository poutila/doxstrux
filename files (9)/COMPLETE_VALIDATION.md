...
> **Updated**: 2025-12-17
> **See also**: `WHERE_WE_ARE.md` for detailed current status

### Linter Generation

Linters are auto-generated by SPEKSI from specs:
- **Input linter**: Generated from `PROSE_INPUT_SPEC.md`
- **Output linter**: Generated from `AI_TASK_LIST_SPEC.md`
- **Location**: `/home/lasse/Dropbox/python/omat/SPEKSI/src/speksi/generated/`

### Test Results

| Stage | Status | Notes |
|-------|--------|-------|
| Input Phase 1 | PASS | `prose_input_linter.py` works correctly |
| Input Phase 2 | Not tested | AI semantic review prompt exists |
| Conversion | PASS | Manual conversion successful |
| Output Phase 1 | BLOCKED | BUG-006 causes 22 false positives |
| Output Phase 2 | Not tested | AI semantic review prompt exists |

### Known Issues in Linters

| Bug | Status | Impact |
|-----|--------|--------|
| BUG-001 | FIXED | YAML enum scoping |
| BUG-002 | FIXED | Prefix extraction |
| BUG-003 | FIXED | Double colon |
| BUG-004 | FIXED | Table scoping |
| BUG-005 | FIXED | Heading level scoping |
| BUG-006 | **OPEN** | Heading prefix filtering needed |

### Commands (using SPEKSI-generated linters)

```bash
# Input validation
uv run python -m speksi.generated.PROSE_INPUT_SPEC.linter.linter INPUT.md

# Output validation
uv run python -m speksi.generated.AI_TASK_LIST_SPEC.linter.linter OUTPUT.md
```
...
| 1.2 | 2025-12-17 | Added implementation status, SPEKSI linter integration |
