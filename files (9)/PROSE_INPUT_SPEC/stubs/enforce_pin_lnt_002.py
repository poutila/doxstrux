...
def enforce_pin_lnt_002(path: Path, text: str) -> List[LintError]:
    """Enforce PIN-LNT-002: Default diagnostics format: `Line N: [RULE_ID] message`
    ...
    return check_policy(
        path, text,
        rule_id="PIN-LNT-002",
        policy_description="Default diagnostics format: `Line N: [RULE_ID] message`"
    )
