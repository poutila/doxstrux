...
def enforce_inv_complete_a(path: Path, text: str) -> List[LintError]:
    """
    Enforce INV-COMPLETE-A: All placeholders MUST be replaced before conversion
    ...
    # TODO: Implement enforcement logic for INV-COMPLETE-A
