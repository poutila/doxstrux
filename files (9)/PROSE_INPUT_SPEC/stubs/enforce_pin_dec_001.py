...
def enforce_pin_dec_001(path: Path, text: str) -> List[LintError]:
    """Enforce PIN-DEC-001: Decisions table MUST have at least one decision row (not just header/separator)"""
