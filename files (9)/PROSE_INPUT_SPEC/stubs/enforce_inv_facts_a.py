...
def enforce_inv_facts_a(path: Path, text: str) -> List[LintError]:
    """
    Enforce INV-FACTS-A: Facts are provided in input, not discovered during conversion
    ...
    # TODO: Implement enforcement logic for INV-FACTS-A
