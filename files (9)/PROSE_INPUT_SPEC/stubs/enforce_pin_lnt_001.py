...
def enforce_pin_lnt_001(path: Path, text: str) -> List[LintError]:
    """Enforce PIN-LNT-001: Linter exit codes: 0=valid, 1=validation errors, 2=schema/parse error, 3=usage/file error
    ...
    return check_policy(
        path, text,
        rule_id="PIN-LNT-001",
        policy_description="Linter exit codes: 0=valid, 1=validation errors, 2=schema/parse error, 3=usage/file error"
    )
