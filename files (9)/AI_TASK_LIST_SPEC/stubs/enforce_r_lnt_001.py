...
def enforce_r_lnt_001(path: Path, text: str) -> List[LintError]:
    """Enforce R-LNT-001: Linter exit codes: 0=pass, 1=violations, 2=usage error
    ...
    return check_policy(
        path, text,
        rule_id="R-LNT-001",
        policy_description="Linter exit codes: 0=pass, 1=violations, 2=usage error"
    )
