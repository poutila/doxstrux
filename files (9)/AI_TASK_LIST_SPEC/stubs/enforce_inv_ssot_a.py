...
def enforce_inv_ssot_a(path: Path, text: str) -> List[LintError]:
    """
    Enforce INV-SSOT-A: Spec is authoritative; linter implements spec
    ...
    # TODO: Implement enforcement logic for INV-SSOT-A
