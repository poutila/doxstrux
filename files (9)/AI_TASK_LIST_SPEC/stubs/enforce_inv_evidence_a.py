...
def enforce_inv_evidence_a(path: Path, text: str) -> List[LintError]:
    """
    Enforce INV-EVIDENCE-A: Evidence in instantiated mode MUST be real output, not fabricated
    ...
    # TODO: Implement enforcement logic for INV-EVIDENCE-A
