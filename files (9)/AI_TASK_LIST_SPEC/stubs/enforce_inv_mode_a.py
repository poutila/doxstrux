...
def enforce_inv_mode_a(path: Path, text: str) -> List[LintError]:
    """
    Enforce INV-MODE-A: Mode determines placeholder tolerance; no exceptions
    ...
    # TODO: Implement enforcement logic for INV-MODE-A
