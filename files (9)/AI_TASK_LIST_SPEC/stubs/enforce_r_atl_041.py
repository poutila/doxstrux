...
def enforce_r_atl_041(path: Path, text: str) -> List[LintError]:
    """Enforce R-ATL-041: Each non-Phase-0 task MUST include `### STOP — Clean Table` with evidence slots and checklists"""
