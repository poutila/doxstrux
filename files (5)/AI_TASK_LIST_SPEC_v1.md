# AI Task List Spec v1.1

**Spec ID**: `AI_TASK_LIST_SPEC_V1_1`  
**Schema version**: `1.1`  
...
**Rationale**: Catches common mistakes like bare `pytest` instead of `uv run pytest`, which causes environment mismatches.
...
A document is **Spec v1.1 compliant** if:

1. ✅ Has required YAML metadata (schema_version: "1.1") and required headings (9 total)
2. ✅ Naming rule stated once (R-ATL-033)
...
7. ✅ **NEW**: Non-empty evidence in instantiated mode (R-ATL-023)
8. ✅ Drift Ledger Evidence contains path:line witness in instantiated mode (R-ATL-D3)
9. ✅ search_tool=rg forbids grep in code blocks only (R-ATL-D4)
10. ✅ Runner prefix enforced on all runner-managed commands (R-ATL-071)
11. ✅ Runner-specific rules enforced (R-ATL-072 for uv)
