...
SRC_YAML = ROOT / "regex_refactor_docs" / "performance" / "DETAILED_TASK_LIST_template.yaml"
OUT_JSON = SRC_YAML.with_suffix(".json")
OUT_MD = SRC_YAML.with_suffix(".md")
