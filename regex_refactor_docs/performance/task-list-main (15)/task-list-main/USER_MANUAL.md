...
SCHEMA = json.loads(Path("src/tasklist/schemas/detailed_task_list.schema.json").read_text(encoding="utf-8"))
...
yaml_obj = {
    ...
    "metadata": {
        ...
        "phase_unlock_mechanism": {
            "enforcement": "Phase 1 requires phase_0_complete.json",
            "artifact_schema": {
                "schema_version": "2.0.0",
                "min_schema_version": "2.0.0",
                "phase": 0,
                "phase_name": "Bootstrap from prose",
                "baseline_pass_count": 1,
                "ci_gates_passed": ["G1"],
                "metric_before": "manual",
                "metric_after": "automated",
                "performance_delta_median": 0.0,
                "performance_delta_p95": 0.0,
                "git_commit": "TBD_COMMIT",
                "completion_date": "TBD_UTC",
            },
            "validation_command": "python tools/validate_phase_artifact.py",
        },
    },
    "ci_gates": [
