...
Usage
    ...
    tasklist-render-template --template docs/phase_template.yaml --replacements config/phase08_values.yml

    # render and write to file
    tasklist-render-template -t docs/phase_template.yaml -r config/phase08_values.yml -o RUN_TO_GREEN.md

    # render using only environment variables, strict mode (fail if unresolved)
    POLICY_REQUIRE_HMAC=true tasklist-render-template -t docs/phase_template.yaml --strict
