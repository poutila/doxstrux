...
def test_render_preserves_timestamps_when_yaml_unchanged(tmp_path, monkeypatch):
    ...
    assert initial_json["template_metadata"]["last_rendered_utc"] == first_timestamp
    ...
    assert rerendered_json["template_metadata"]["last_rendered_utc"] == first_timestamp
...
def test_render_updates_timestamps_when_yaml_changes(tmp_path, monkeypatch):
    ...
    assert data["template_metadata"]["last_rendered_utc"] == updated_timestamp
